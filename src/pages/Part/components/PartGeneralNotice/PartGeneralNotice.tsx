...
export default function PartGeneralNotice({part_name, car_name, part_number}){
  return (
    <div className={`container ${style.part__description}`}>
      ...
      <p>Looking for high quality used car parts near you? With an unparalleled selection of used car parts of all
      ...
      <p>At the moment, on our site you will find more than 19037353 unique ads from different used auto parts dealers.
